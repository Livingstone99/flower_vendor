...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', get_enum_type('userrole', ('customer', 'admin')), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('provider', get_enum_type('oauthprovider', ('google', 'facebook')), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('kind', get_enum_type('productkind', ('plant', 'bouquet', 'vase', 'digital_service')), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('plant_environment', get_enum_type('plantenvironment', ('indoor', 'outdoor', 'both')), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', get_enum_type('orderstatus', ('draft', 'placed', 'pending_payment', 'confirmed', 'cancelled')), nullable=False),
